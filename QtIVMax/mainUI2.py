...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("assets/60IVMaxLogoArtboard 1.png"))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.Top_Bar)
        self.label_2.setGeometry(QtCore.QRect(130, 27, 121, 41))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("assets/60IVMaxLetterArtboard 1.png"))
...
"combobox-popup: 0;  padding: 0px 0px 0px 0px;")
